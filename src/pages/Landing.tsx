    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-20 relative overflow-hidden bg-[#0a0908]">
      ...
      <div className="max-w-3xl w-full text-center relative z-10">
        ...
        <button
          ...
          className="museum-button px-12 py-6 text-[11px] tracking-[0.4em] bg-transparent text-[var(--color-museum-text)] hover:shadow-[0_0_50px_rgba(197,168,122,0.1)] border-[var(--color-museum-accent)]/30"
        >
          <span className="relative z-10">{language === 'en' ? 'Enter the Archive' : '进入档案库'}</span>
        </button>
